...
return [
     ...
     */
    'max_file_size' => (int) env('UPLOAD_MAX_SIZE', 1024 * 1024 * 100), // default 100MB
     ...
     */
    'media_model' => App\Models\AppMedia::class,
    ...
    'custom_path_generators' => [
        \App\Models\MediaLibrary::class => \App\Support\MediaLibrary\DatePathGenerator::class,
    ],
