...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Appearance builders (homepage, header, footer layout documents)
    Route::prefix('appearance')->middleware('throttle:api')->group(function () {
        ...
        Route::get('header', [\App\Http\Controllers\Api\AppearanceController::class, 'showHeader']);
    ...
    Route::prefix('v1')->name('v1.')->middleware('throttle:api')->group(function () {
        ...
        Route::middleware('feature.module:categories')->group(function () {
            ...
            Route::post('categories/import', [\App\Http\Controllers\Api\CategoryController::class, 'import'])->middleware('throttle:bulk');
